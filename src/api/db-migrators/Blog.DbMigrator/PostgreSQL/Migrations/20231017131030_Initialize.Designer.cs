...
namespace Sisa.Blog.DbMigrator.PostgreSQL.Migrations
{
    ...
    [Migration("20231017131030_Initialize")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Sisa.Blog.Domain.AggregatesModel.CategoryAggregate.Category", b =>
                {
                    ...
                    NpgsqlIndexBuilderExtensions.IncludeProperties(b.HasIndex("Slug"), new[] { "Name" });
            ...
            modelBuilder.Entity("Sisa.Blog.Domain.AggregatesModel.CommentAggregate.Comment", b =>
                {
                    ...
                    b.Property<IReadOnlyCollection<ReactionCounter>>("ReactionCounts")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("jsonb")
            ...
            modelBuilder.Entity("Sisa.Blog.Domain.AggregatesModel.CommentAggregate.CommentReaction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Sisa.Blog.Domain.AggregatesModel.PostAggregate.Post", b =>
                {
                    ...
                    b.Property<List<string>>("TagSlugs")
                        .IsRequired()
                        .HasColumnType("text[]")
                    ...
                    NpgsqlIndexBuilderExtensions.IncludeProperties(b.HasIndex("Slug"), new[] { "Title" });

                    b.ToTable("posts");
                });

            modelBuilder.Entity("Sisa.Blog.Domain.AggregatesModel.PostAggregate.PostReaction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
